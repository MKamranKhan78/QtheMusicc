...
class CommonKeys {
    companion object {
        const val KEY_PAYMENT_TYPE_ = "_key_payment_type_"
        ...
        const val KEY_USER_COUNTRY = "_key_user_country"
        const val KEY_USER_ZIP_CODE = "_key_user_zip_code"
        const val KEY_USER_PLAN_ID = "_key_user_plan_id"
        const val KEY_USER_PLAN_TITLE = "_key_user_plan_title"
